...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	Mit einem zufällig bei Autor noch vorhandenen Rechner mit Windows 95 die Daten auszulesen, war ebenfalls nicht erfolgreich, da das integrierte Diskettenlaufwerk durch Alterung nicht mehr funktionierte.
	...
	\begin{figure}[p]
		\begin{center}
			...
			\caption{Warnung beim Start von Windows 2.11 anch der Installation von Excel}
